...
// */
//public class LoginOpenPlatformRequest extends PostJsonRequest {
//    private UserDao userDao;
//    private String type;//QQ、WeChat
//    private String openId;//第三方id，唯一标示用户
//    private Object info;//第三方返回的数据字符串
//    private BibleDao bibleDao;
//
//    public LoginOpenPlatformRequest(Handler h, Context c, String type, String openId, Object info) {
//        this.handler = h;
//        this.context = c;
//        this.type = type;
//        this.openId = openId;
...
//        LoginOpenPlatformActionInfo actionInfo = new LoginOpenPlatformActionInfo(2, type, openId, info);
...
//                // 集成友盟账号统计功能--第三方登录
//                MobclickAgent.onProfileSignIn("type", String.valueOf(info.getUserInfo().getUid()));
//
//                LogUtil.i("login from open platform success");
//            }
//            //响应失败
//            else {
...
//                msg.setData(b);
//                handler.sendMessage(msg);
//                LogUtil.e("login from open platform failure: code: " + info.getCode() + ",message: " + info.getMessage(), null);
//            }
//        } catch (Throwable e) {
//            handler.sendEmptyMessage(MessageSignConstant.UNKNOWN_ERROR);
//            LogUtil.e("login from open platform error", e);
//        }
//    }
//}