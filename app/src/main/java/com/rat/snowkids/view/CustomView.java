...
public class CustomView extends View {
    ...
    private void initAttrs(AttributeSet attr, Context context) {
        ...
        roundColor = array.getColor(R.styleable.CustomView_roundColor, context.getResources().getColor(R.color.gray_8d));//环形颜色
        progressColor = array.getColor(R.styleable.CustomView_progressColor, context.getResources().getColor(R.color.red_d2));//进度颜色
        ...
        textColor = array.getColor(R.styleable.CustomView_textColor, context.getResources().getColor(R.color.red_d2));//文字颜色
