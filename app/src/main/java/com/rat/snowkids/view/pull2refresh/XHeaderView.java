package com.rat.snowkids.view.pull2refresh;
...
public class XHeaderView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.view_xlist_header, null);
