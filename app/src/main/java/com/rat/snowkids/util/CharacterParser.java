...
public class CharacterParser {
    private static int[] pyvalue = new int[]{-20319, -20317, -20304, -20295,
            ...
            -10296, -10281, -10274, -10270, -10262, -10260, -10256, -10254, -7431, -7226};
    public static String[] pystr = new String[]{"a", "ai", "an", "ang", "ao",
            ...
            "zong", "zou", "zu", "zuan", "zui", "zun", "zuo", "yi", "yan"};
     ...
     */
    public String getSpell(String chs) {
        String key, value;
    ...
    public String getSpelling() {
        return this.getSpell(this.getResource());
    }
