...
import com.rat.snowkids.adapter.AlarmListAdapter;
import com.rat.snowkids.common.MessageSignConstant;
import com.rat.snowkids.controller.AlarmController;
...
public class AlarmListActivity extends BaseActivity implements AdapterView.OnItemClickListener, XListView.IXListViewListener {
    ...
    private void updateData(DataGetType dataGetType) {
        controller.getList(totalPage, currentPage, dataGetType, alarmType, timeStart, timeEnd, deviceId);
    }
