...
public class CircleProgress extends View {
    ...
    protected void initForePaint() {
        forePaint = new Paint();
        forePaint.setStrokeWidth(mStrokeWidth - 30);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mPaintRectF, 230, maxProgress, isSolid, bgPaint);
        canvas.drawArc(mPaintRectF, 230, currProgress, isSolid, forePaint);
    }
